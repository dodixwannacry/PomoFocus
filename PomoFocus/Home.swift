        ...
        VStack(spacing: 15){
            ...
            HStack(spacing: 15){
                Text ("\(pomodoroModel.hour) hr")
                    ...
                    .contextMenu{
                        ContextMenuOptions(maxValue: 12, hint: "hr") {value in pomodoroModel.hour = value
                        }
                    }
                ...
                Text ("\(pomodoroModel.minutes) min")
                    ...
                    .contextMenu{
                        ContextMenuOptions(maxValue: 60, hint: "min") {value in pomodoroModel.minutes = value
                        }
                    }
                ...
                Text ("\(pomodoroModel.seconds) sec")
                    ...
                    .contextMenu{
                        ContextMenuOptions(maxValue: 60, hint: "sec") {value in pomodoroModel.seconds = value
                        }
                    }
